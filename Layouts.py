...
tab1, tab2, tab3 = st.tabs(["Sales Data","Customer Insight", "Market Trends"])
with tab1:
  st.write("Content for Sales Data")
  sales_data = {"Q1 2024": "$1.2M",
        "Q2 2024": "$1.5M",
        "Q3 2024": "$1.3M",
        "Q4 2024": "$1.6M"
    }
  for quarter, revenue in sales_data.item():
...
with tab3:
  ...
  market_tend = {
    "Eco-friendly product": " Increasing demand",
    "Online shopping": "Continued growth",
    "Subscription services": "Rising popularity"
    }
  for trend, status in market_tend.item():
    st.write(f"{tend}: {status}")
